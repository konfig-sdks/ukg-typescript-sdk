...
export const SchoolApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {CodeObject} codeObject The school code to be written.
        ...
        updateConfiguration: async (code: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/school/{code}`
...
export const SchoolApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * \'Creates a new UKG Pro school configuration.\' 
         * @summary Create a new school configuration
         * @param {SchoolApiCreateConfigurationRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async createConfiguration(requestParameters: SchoolApiCreateConfigurationRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
         ...
         * \'Allows the ability update a single school configuration.\' 
         * @summary Update a single school configuration
         * @param {SchoolApiUpdateConfigurationRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async updateConfiguration(requestParameters: SchoolApiUpdateConfigurationRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
...
export const SchoolApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        createConfiguration(requestParameters: SchoolApiCreateConfigurationRequest, options?: AxiosRequestConfig): AxiosPromise<void> {
         ...
         * @throws {RequiredError}
         */
        updateConfiguration(requestParameters: SchoolApiUpdateConfigurationRequest, options?: AxiosRequestConfig): AxiosPromise<void> {
...
/**
 * Request parameters for createConfiguration operation in SchoolApi.
 * @export
 * @interface SchoolApiCreateConfigurationRequest
 */
export type SchoolApiCreateConfigurationRequest = {
    
} & CodeObject

/**
 * Request parameters for updateConfiguration operation in SchoolApi.
 * @export
 * @interface SchoolApiUpdateConfigurationRequest
 */
export type SchoolApiUpdateConfigurationRequest = {
    
    /**
    * Project code.
    * @type {string}
    * @memberof SchoolApiUpdateConfiguration
    */
...
/**
 * SchoolApiGenerated - object-oriented interface
 * @export
 * @class SchoolApiGenerated
 * @extends {BaseAPI}
 */
export class SchoolApiGenerated extends BaseAPI {
    /**
     * \'Creates a new UKG Pro school configuration.\' 
     * @summary Create a new school configuration
     * @param {SchoolApiCreateConfigurationRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof SchoolApiGenerated
     */
    public createConfiguration(requestParameters: SchoolApiCreateConfigurationRequest, options?: AxiosRequestConfig) {
        return SchoolApiFp(this.configuration).createConfiguration(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getConfigurations(options?: AxiosRequestConfig) {
        return SchoolApiFp(this.configuration).getConfigurations(options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof SchoolApiGenerated
     */
    public updateConfiguration(requestParameters: SchoolApiUpdateConfigurationRequest, options?: AxiosRequestConfig) {
        return SchoolApiFp(this.configuration).updateConfiguration(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
